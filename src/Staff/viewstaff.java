...
public class viewstaff extends javax.swing.JFrame {
    ...
    public viewstaff() {
        ...
        Object columns[] = {"SID","Name","address","email","contact","dob","Password"};
    ...
    public void loadData() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                columnData[5] = rs.getString("login");
    ...
    private void initComponents() {
        ...
        pTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Title 1", "table2", "Title 3", "Title 4", "Title 5", "Title 6", "Title 7", "Title 8"
            }
        ));
        ...
        if (pTable.getColumnModel().getColumnCount() > 0) {
            ...
            pTable.getColumnModel().getColumn(1).setHeaderValue("tabl 2");
            pTable.getColumnModel().getColumn(2).setHeaderValue("Title 3");
            pTable.getColumnModel().getColumn(3).setHeaderValue("Title 4");
        }

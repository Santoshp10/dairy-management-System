...
public class Transaction extends javax.swing.JFrame {
    ...
    public Transaction() {
        ...
        Object columns[] = {"TID","CID","Name","Product","Quantity","Rate","Amount"};
    ...
    public void loadData() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                columnData[1] = rs.getString("CID");
                columnData[2] = rs.getString("Name");
                columnData[3] = rs.getString("Product");
                columnData[4] = rs.getString("Quantity");
                columnData[5] = rs.getString("Rate");
                columnData[6] = rs.getString("Amount");
    ...
    private void initComponents() {
        ...
        jLabel14.setText("View Payments");
